...
class DirectoryProcessingWorker(QThread):
    ...
    def __init__(self, directory_path, window_size=5, channels=None, calculate_hrv=True, 
            ...
            for i, folder in enumerate(subfolders):
                ...
                try:
                    ...
                    for channel in self.channels:
                        ...
                        # Append to results
                        results[channel]['ppi_data'] = pd.concat([results[channel]['ppi_data'], data_sample])
                        ...
                        try:
                            ...
                            if 'Folder' in results[channel]['ppi_data'].columns:
                                ...
                                for idx, row in results[channel]['hrv_metrics'].iterrows():
                                    ...
                                    results[channel]['hrv_metrics'].at[idx, 'Folder'] = results[channel]['ppi_data'].at[closest_idx, 'Folder']
